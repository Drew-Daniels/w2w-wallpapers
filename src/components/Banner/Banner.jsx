...
export function Banner(props) {
    ...
    return (
        <Container className='py-2 mt-2' fluid style={{ backgroundColor: 'rgb(0, 30, 60)', borderRadius: '.25em', border: '1px solid rgb(19, 47, 76)' }}>
            <Row>
                <Col sm={12} md={12} lg={2} className='d-flex justify-content-center'>
                ...
                <Col sm={12} md={12} lg={2} className='d-flex justify-content-center align-items-center'>
